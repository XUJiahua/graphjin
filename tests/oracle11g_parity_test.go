...
func oracle11gUnsupportedParityReasons() map[string]string {
	reasons := map[string]string{
		...
		"Example_insert":                                          "oracle11g is a read-only path and does not support mutations",
		"Example_insertWithTransaction":                           "oracle11g is a read-only path and does not support mutations",
		"Example_insertInlineWithValidation":                      "oracle11g is a read-only path and does not support mutations",
		"Example_insertInlineBulk":                                "oracle11g is a read-only path and does not support mutations",
		"Example_insertWithPresets":                               "oracle11g is a read-only path and does not support mutations",
		"Example_insertBulk":                                      "oracle11g is a read-only path and does not support mutations",
		"Example_insertIntoMultipleRelatedTables":                 "oracle11g is a read-only path and does not support mutations",
		"Example_insertIntoTableAndRelatedTable1":                 "oracle11g is a read-only path and does not support mutations",
		"Example_insertIntoTableAndRelatedTable2":                 "oracle11g is a read-only path and does not support mutations",
		"Example_insertIntoTableBulkInsertIntoRelatedTable":       "oracle11g is a read-only path and does not support mutations",
		"Example_insertIntoTableAndConnectToRelatedTables":        "oracle11g is a read-only path and does not support mutations",
		"Example_insertWithCamelToSnakeCase":                      "oracle11g is a read-only path and does not support mutations",
		"Example_insertIntoRecursiveRelationship":                 "oracle11g is a read-only path and does not support mutations",
		"Example_insertIntoRecursiveRelationshipAndConnectTable1": "oracle11g is a read-only path and does not support mutations",
		"Example_insertIntoRecursiveRelationshipAndConnectTable2": "oracle11g is a read-only path and does not support mutations",
		"Example_update":                                          "oracle11g is a read-only path and does not support mutations",
		"Example_updateMultipleRelatedTables1":                    "oracle11g is a read-only path and does not support mutations",
		"Example_updateTableAndConnectToRelatedTables":            "oracle11g is a read-only path and does not support mutations",
		"Example_updateTableAndRelatedTable":                      "oracle11g is a read-only path and does not support mutations",
		"Example_setArrayColumnToValue":                           "oracle11g is a read-only path and does not support mutations",
		"Example_setArrayColumnToEmpty":                           "oracle11g is a read-only path and does not support mutations",
